  ...
  return (
    <header className={`${styles.header} px-4 py-2`}>
      <div className="flex items-center justify-between w-full">
        ...
        {/* centered logo */}
        <div className="w-1/3 flex justify-center" id="homeBtn">
          <Image
        ...
        <div className="w-1/3 flex items-center justify-end gap-4">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              className="px-3 py-1 rounded-md border border-white/40 bg-white/10 text-white hover:bg-white/20 transition text-sm"
              data-lang="en"
              id="lang-en"
            >
              English
          ...
          {/* settings button*/}
          <div className="rounded-full bg-gray-200 p-2" id="settingsBtn">
            <svg
